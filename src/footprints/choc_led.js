  ...
  body: p => {
    `
      (module Choc_Hotswap_SK6812MiniE (layer F.Cu) (tedit 610F112B)
        ...
        (fp_text reference SW4 (at 6.85 8.45 -180) (layer F.SilkS) hide
          (effects (font (size 1 1) (thickness 0.15)))
        )
        (fp_text value SW_PUSH (at -4.95 8.6 -180) (layer F.Fab) hide
          (effects (font (size 1 1) (thickness 0.15)))
        )
        ...
        (fp_line (start -4.4 2.349) (end -4.4 4) (layer B.SilkS) (width 0.12))
        (fp_line (start -4.4 2.349) (end 3.9 2.35154) (layer F.SilkS) (width 0.12))
        (fp_line (start 3.9 7.05154) (end -4.4 7.05154) (layer F.SilkS) (width 0.12))
        (fp_line (start -5.2 -1.4) (end -5.2 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -5.35 -1.4) (end -5.35 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -6.95 -1.7) (end -6.95 -5.65) (layer F.SilkS) (width 0.15))
        (fp_line (start -5.5 -1.4) (end -5.5 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -5.65 -1.4) (end -5.65 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -7.15 -1.95) (end -7.15 -5.5) (layer F.SilkS) (width 0.15))
        (fp_line (start -6.7 -1.5) (end -6.7 -5.9) (layer F.SilkS) (width 0.15))
        (fp_line (start -6.55 -1.45) (end -6.55 -5.95) (layer F.SilkS) (width 0.15))
        (fp_line (start -5.05 -1.4) (end -5.05 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -6.1 -1.4) (end -6.1 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -7.05 -1.8) (end -7.05 -5.55) (layer F.SilkS) (width 0.15))
        (fp_line (start -5.8 -1.4) (end -5.8 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -6.25 -1.4) (end -6.25 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -6.3 -6.025) (end -3.725 -6.025) (layer F.SilkS) (width 0.15))
        (fp_line (start -6.4 -1.4) (end -6.4 -5.95) (layer F.SilkS) (width 0.15))
        (fp_line (start -6.3 -1.375) (end -3.7 -1.375) (layer F.SilkS) (width 0.15))
        (fp_line (start -6.85 -1.6) (end -6.85 -5.8) (layer F.SilkS) (width 0.15))
        (fp_line (start -4.75 -1.4) (end -4.75 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -4.6 -1.4) (end -4.6 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -4.45 -1.4) (end -4.45 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -4.3 -1.4) (end -4.3 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -4.15 -1.4) (end -4.15 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -4 -1.4) (end -4 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -3.85 -1.4) (end -3.85 -5.95) (layer F.SilkS) (width 0.15))
        (fp_line (start -3.7 -1.4) (end -3.7 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -3.55 -1.4) (end -3.55 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -3.4 -1.45) (end -3.4 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -3.25 -1.55) (end -3.25 -6.1) (layer F.SilkS) (width 0.15))
        (fp_line (start -3.1 -1.65) (end -3.1 -6.15) (layer F.SilkS) (width 0.15))
        (fp_line (start -3 -1.8) (end -3 -6.2) (layer F.SilkS) (width 0.15))
        (fp_line (start -2.9 -2.05) (end -2.9 -6.25) (layer F.SilkS) (width 0.15))
        (fp_line (start -2.8 -2.2) (end -2.8 -6.35) (layer F.SilkS) (width 0.15))
        (fp_line (start -2.7 -2.4) (end -2.7 -6.55) (layer F.SilkS) (width 0.15))
        (fp_line (start -2.6 -2.55) (end -2.6 -6.7) (layer F.SilkS) (width 0.15))
        (fp_line (start -2.5 -2.75) (end -2.5 -7.2) (layer F.SilkS) (width 0.15))
        (fp_line (start -2.35 -2.9) (end -2.35 -7.35) (layer F.SilkS) (width 0.15))
        (fp_line (start -2.2 -3.05) (end -2.2 -7.45) (layer F.SilkS) (width 0.15))
        (fp_line (start -2.05 -3.15) (end -2.05 -7.55) (layer F.SilkS) (width 0.15))
        (fp_line (start -1.9 -3.25) (end -1.9 -7.7) (layer F.SilkS) (width 0.15))
        (fp_line (start -1.75 -3.35) (end -1.75 -7.8) (layer F.SilkS) (width 0.15))
        (fp_line (start -1.6 -3.4) (end -1.6 -7.95) (layer F.SilkS) (width 0.15))
        (fp_line (start -1.45 -3.5) (end -1.45 -8.05) (layer F.SilkS) (width 0.15))
        (fp_line (start -1.3 -3.55) (end -1.3 -8.15) (layer F.SilkS) (width 0.15))
        (fp_line (start -1.15 -3.55) (end -1.15 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start -1 -3.55) (end -1 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start -0.85 -3.6) (end -0.85 -8.15) (layer F.SilkS) (width 0.15))
        (fp_line (start -0.7 -3.6) (end -0.7 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start -0.55 -3.6) (end -0.55 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start -0.4 -3.6) (end -0.4 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start -0.25 -3.6) (end -0.25 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start -0.1 -3.6) (end -0.1 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 0.05 -3.6) (end 0.05 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 0.2 -3.6) (end 0.2 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 0.35 -3.6) (end 0.35 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 0.5 -3.6) (end 0.5 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 0.65 -3.6) (end 0.65 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 0.8 -3.6) (end 0.8 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 0.95 -3.6) (end 0.95 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 1.1 -3.6) (end 1.1 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 1.25 -3.6) (end 1.25 -8.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 1.4 -3.75) (end 1.4 -8.1) (layer F.SilkS) (width 0.15))
        (fp_line (start 1.55 -3.85) (end 1.55 -7.95) (layer F.SilkS) (width 0.15))
        (fp_line (start 1.7 -4) (end 1.7 -7.8) (layer F.SilkS) (width 0.15))
        (fp_line (start 1.85 -4.15) (end 1.85 -7.65) (layer F.SilkS) (width 0.15))
        (fp_line (start 2 -4.35) (end 2 -7.5) (layer F.SilkS) (width 0.15))
        (fp_line (start 2.15 -4.45) (end 2.15 -7.35) (layer F.SilkS) (width 0.15))
        (fp_line (start -1.275 -8.225) (end -2.55 -7.2) (layer F.SilkS) (width 0.15))
        (fp_line (start 2.3 -7.2) (end 1.275 -8.225) (layer F.SilkS) (width 0.15))
        (fp_line (start 2.3 -4.6) (end 1.275 -3.575) (layer F.SilkS) (width 0.15))
        (fp_line (start 2.3 -7.2) (end 2.3 -4.6) (layer F.SilkS) (width 0.15))
        (fp_line (start -7.3 -5.025) (end -7.3 -2.375) (layer F.SilkS) (width 0.15))
        (fp_line (start -0.7 -3.575) (end 1.275 -3.575) (layer F.SilkS) (width 0.15))
        (fp_line (start -1.275 -8.225) (end 1.275 -8.225) (layer F.SilkS) (width 0.15))
        (fp_line (start -4.9 -1.4) (end -4.9 -6) (layer F.SilkS) (width 0.15))
        (fp_line (start -5.95 -1.4) (end -5.95 -6) (layer F.SilkS) (width 0.15))
        ...
        (pad 5 smd rect (at -2.8 -5.9) (size 1.6 2.2) (layers B.Cu B.Paste B.Mask) ${p.net.from.str})
        (pad 6 smd rect (at 7.8 -3.7) (size 1.6 2.2) (layers B.Cu B.Paste B.Mask)
          (clearance 0.3) ${p.net.to.str})
        (pad 6 smd rect (at -7.9 -3.7) (size 1.6 2.2) (layers F.Cu F.Paste F.Mask)
          (clearance 0.5) ${p.net.to.str})
        (pad 5 smd rect (at 2.8 -5.9) (size 1.6 2.2) (layers F.Cu F.Paste F.Mask) ${p.net.from.str})
        (pad "" np_thru_hole circle (at -5 -3.7 90) (size 3 3) (drill 3) (layers *.Cu *.Mask))
        (pad "" np_thru_hole circle (at 5.22 4.2) (size 1 1) (drill 1) (layers *.Cu *.Mask))
        (pad "" np_thru_hole circle (at -5.22 4.2) (size 1 1) (drill 1) (layers *.Cu *.Mask))
        (pad 2 smd rect (at 2.75 5.399) (size 1.7 1) (layers F.Cu F.Paste F.Mask) ${p.net.din.str})
        (pad 3 smd rect (at -2.75 5.399) (size 1.7 1) (layers F.Cu F.Paste F.Mask) ${p.net.GND.str})
        (pad 1 smd rect (at 2.75 3.999) (size 1.7 1) (layers F.Cu F.Paste F.Mask) ${p.net.VCC.str})
        (pad 4 smd rect (at -2.75 3.999) (size 1.7 1) (layers F.Cu F.Paste F.Mask) ${p.net.dout.str})
        (pad 3 smd rect (at -2.75 3.999) (size 1.7 1) (layers B.Cu B.Paste B.Mask) ${p.net.GND.str})
        (pad 2 smd rect (at 2.75 3.999) (size 1.7 1) (layers B.Cu B.Paste B.Mask) ${p.net.din.str})
        (pad 4 smd rect (at -2.75 5.399) (size 1.7 1) (layers B.Cu B.Paste B.Mask) ${p.net.dout.str})
        (pad 1 smd rect (at 2.75 5.399) (size 1.7 1) (layers B.Cu B.Paste B.Mask) ${p.net.VCC.str})
      )
    `
  }
}
